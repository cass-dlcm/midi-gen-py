...
def guitar_pattern_repeat_recursion(level: Dict[str, Union[str, int, Dict[str, Union[str, list]]]], guitar_track: MidiTrack, sequences: List[List[List[int]]], a: int, b: int):
...
def guitar(guitar_track: MidiTrack, progression_length: int,
    ...
    for a in range(0, segments):
        for b in range(0, progression_length):
            pickPattern: Dict[str, Union[str, int, List[Dict[str, Union[str, int, Dict[str, Union[str, list]]]]]]] = choice(guitar_patterns)
